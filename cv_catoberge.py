...
# VIL HA DISSE I MIDTEN AV NAVBAR. FINN UT!
st.markdown(
    """
...
txt(
    "*2011-2014*",
    """**Mastergrad samfunnskommunikasjon**, Universitet i Agder 
...
txt(
    "*2004-2007*",
    """**Bachelorgrad kommunikasjon**, Universitet i Agder 
...
- Redaktør nettsider EVU/UiA Videre. CMS er EZ Publish.
- Teknisk ressurs i seksjonen. Involvert i fremtidig overføring av statistikk fra Tableau til PowerBI.

""",
)
txt(
    "*mai 2021-nov. 2021*",
    """**Kommunikasjonskonsulent**, Nasjonal kommunikasjonsmyndighet
...
txt(
    "*mai 2020-mar. 2021*",
    """**Konsulent**, Pegasus Kontroll og Kompetanse
...
txt(
    "*jan. 2019-des. 2019*",
    """**Kvalitetssikring**, Pegasus Kontroll og Kompetanse
...
txt(
    "*aug. 2009-des. 2019*",
    """**Sivil vekter/kontrollør**, Pegasus Kontroll og Kompetanse
...
txt(
    "*sep. 2012-okt. 2012*",
    """**Praksis mastergrad samfunnskommunikasjon**, Innoventus AS
...
txt(
    "*des. 2007-apr. 2009*",
    """**Produksjonsmedarbeider**, Osigraf AS
...
txt4(
    "Markedsføring", "**Fundamentals of digital marketing**", "*Google Digital Garage*"
)
...
txt4(
    "Design thinking", "**Prosessledelse og design tenking**", "*Universitetet i Agder*"
)
...
txt3("GitHub", "https://github.com/catoberge")
